...
Blockly.Blocks['arm_init'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("    机械臂类型")
        .appendField(new Blockly.FieldDropdown([["xarm5","0"], ["xarm6","1"], ["xarm7","2"], ["anno","3"], ["anno_pro","4"], ["g602","5"], ["g603","6"]]), "arm")
        .appendField(", 设置")
...
Blockly.Blocks['set_vaccum_gripper'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("设置气动夹爪:  ")
        .appendField(new Blockly.FieldDropdown([["open","0"], ["close","1"]]), "enable");
    this.appendDummyInput()
        .appendField("    气泵IO编号")
        .appendField(new Blockly.FieldTextInput("1"), "pump_io_num")
        .appendField(", 气阀IO编号")
        .appendField(new Blockly.FieldTextInput("2"), "changer_io_num")
        .appendField(", 间隔时间")
        .appendField(new Blockly.FieldTextInput("3"), "time_sleep_s")
        .appendField("s");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(310);
 this.setTooltip("设置气动夹爪");
 this.setHelpUrl("先控制气泵，间隔n秒后再控制气阀");
  }
};

Blockly.Blocks['set_electric_gripper'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("设置电动夹爪:  速度")
        .appendField(new Blockly.FieldTextInput("50"), "velocity_scale")
        .appendField("%,")
        .appendField("位置")
        .appendField(new Blockly.FieldTextInput("50"), "position_scale")
        .appendField("%");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(310);
 this.setTooltip("设置电动夹爪");
 this.setHelpUrl("");
  }
};