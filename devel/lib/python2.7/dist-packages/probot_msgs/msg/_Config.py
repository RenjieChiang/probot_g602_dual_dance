...
class Config(genpy.Message):
  _md5sum = "2140a2cd47f33c6649b1e6b52754c1e2"
...
"""
  ...
  __slots__ = ['controller_log_level','init_with_all_zero_pos','enable_joint_calibration','seneor_position','speed_to_sensor','speed_to_zero','pump_io_number','changer_io_number','pose_to_eef','mask']
  _slot_types = ['int8','bool','bool','float32[]','float32[]','float32[]','int8','int8','geometry_msgs/Pose[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       controller_log_level,init_with_all_zero_pos,enable_joint_calibration,seneor_position,speed_to_sensor,speed_to_zero,pump_io_number,changer_io_number,pose_to_eef,mask
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.seneor_position))
      length = len(self.speed_to_sensor)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.speed_to_sensor))
      length = len(self.speed_to_zero)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.speed_to_zero))
      _x = self
      buff.write(_get_struct_2b().pack(_x.pump_io_number, _x.changer_io_number))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.seneor_position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.speed_to_sensor = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.speed_to_zero = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 2
      (_x.pump_io_number, _x.changer_io_number,) = _get_struct_2b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pose_to_eef = []
