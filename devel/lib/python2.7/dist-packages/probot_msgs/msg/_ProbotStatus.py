...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.jointsPosition))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.outputRelay))
      length = len(self.inputButton)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.inputButton))
      length = len(self.inputLimitSensors)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.inputLimitSensors))
      length = len(self.inputHomeSensors)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.inputHomeSensors))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.jointsPosition = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 56
      ...
      self.outputRelay = struct.unpack(pattern, str[start:end])
      ...
      self.inputButton = struct.unpack(pattern, str[start:end])
      ...
      self.inputLimitSensors = struct.unpack(pattern, str[start:end])
      ...
      self.inputHomeSensors = struct.unpack(pattern, str[start:end])
