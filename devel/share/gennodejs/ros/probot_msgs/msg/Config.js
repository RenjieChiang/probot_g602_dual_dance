...
class Config {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int8(obj.pump_io_number, buffer, bufferOffset);
    // Serialize message field [changer_io_number]
    bufferOffset = _serializer.int8(obj.changer_io_number, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.pump_io_number = _deserializer.int8(buffer, bufferOffset);
    // Deserialize message field [changer_io_number]
    data.changer_io_number = _deserializer.int8(buffer, bufferOffset);
