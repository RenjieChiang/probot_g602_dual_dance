...
(cl:in-package probot_blockly-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetCurrentBlockId-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCurrentBlockId-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name probot_blockly-srv:<SetCurrentBlockId-request> is deprecated: use probot_blockly-srv:SetCurrentBlockId-request instead.")))

(cl:ensure-generic-function 'block_id-val :lambda-list '(m))
(cl:defmethod block_id-val ((m <SetCurrentBlockId-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader probot_blockly-srv:block_id-val is deprecated.  Use probot_blockly-srv:block_id instead.")
  (block_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCurrentBlockId-request>)))
  ...
  "probot_blockly/SetCurrentBlockIdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCurrentBlockId-request)))
  "Returns string type for a service object of type 'SetCurrentBlockId-request"
  "probot_blockly/SetCurrentBlockIdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCurrentBlockId-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCurrentBlockId-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name probot_blockly-srv:<SetCurrentBlockId-response> is deprecated: use probot_blockly-srv:SetCurrentBlockId-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SetCurrentBlockId-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader probot_blockly-srv:result-val is deprecated.  Use probot_blockly-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCurrentBlockId-response>)))
  ...
  "probot_blockly/SetCurrentBlockIdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCurrentBlockId-response)))
  "Returns string type for a service object of type 'SetCurrentBlockId-response"
  "probot_blockly/SetCurrentBlockIdResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCurrentBlockId)))
  ...
  "probot_blockly/SetCurrentBlockId")