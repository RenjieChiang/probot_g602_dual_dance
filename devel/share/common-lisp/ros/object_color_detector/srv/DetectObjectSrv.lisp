...
(cl:in-package object_color_detector-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectObjectSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectObjectSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_color_detector-srv:<DetectObjectSrv-request> is deprecated: use object_color_detector-srv:DetectObjectSrv-request instead.")))

(cl:ensure-generic-function 'objectType-val :lambda-list '(m))
(cl:defmethod objectType-val ((m <DetectObjectSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_color_detector-srv:objectType-val is deprecated.  Use object_color_detector-srv:objectType instead.")
  (objectType m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectObjectSrv-request>)))
  ...
  "object_color_detector/DetectObjectSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectObjectSrv-request)))
  "Returns string type for a service object of type 'DetectObjectSrv-request"
  "object_color_detector/DetectObjectSrvRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectObjectSrv-request>)))
  ...
  "48ea0118b512eb884c42e18a92c6a0ea")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectObjectSrv-request)))
  "Returns md5sum for a message object of type 'DetectObjectSrv-request"
  "48ea0118b512eb884c42e18a92c6a0ea")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DetectObjectSrv-request>)))
  ...
  (cl:format cl:nil "# The detect object service commands robot to find objects pose~%~%# request constants~%int32 RED_OBJECT    = 0~%int32 GREEN_OBJECT  = 1~%int32 BLUE_OBJECT   = 2~%int32 BLACK_OBJECT  = 3~%~%int32 ALL_OBJECT    = 255~%~%~%# object type:~%int32 objectType~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DetectObjectSrv-request)))
  "Returns full string definition for message of type 'DetectObjectSrv-request"
  (cl:format cl:nil "# The detect object service commands robot to find objects pose~%~%# request constants~%int32 RED_OBJECT    = 0~%int32 GREEN_OBJECT  = 1~%int32 BLUE_OBJECT   = 2~%int32 BLACK_OBJECT  = 3~%~%int32 ALL_OBJECT    = 255~%~%~%# object type:~%int32 objectType~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <DetectObjectSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectObjectSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_color_detector-srv:<DetectObjectSrv-response> is deprecated: use object_color_detector-srv:DetectObjectSrv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <DetectObjectSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_color_detector-srv:result-val is deprecated.  Use object_color_detector-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'redObjList-val :lambda-list '(m))
(cl:defmethod redObjList-val ((m <DetectObjectSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_color_detector-srv:redObjList-val is deprecated.  Use object_color_detector-srv:redObjList instead.")
  (redObjList m))

(cl:ensure-generic-function 'greenObjList-val :lambda-list '(m))
(cl:defmethod greenObjList-val ((m <DetectObjectSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_color_detector-srv:greenObjList-val is deprecated.  Use object_color_detector-srv:greenObjList instead.")
  (greenObjList m))

(cl:ensure-generic-function 'blueObjList-val :lambda-list '(m))
(cl:defmethod blueObjList-val ((m <DetectObjectSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_color_detector-srv:blueObjList-val is deprecated.  Use object_color_detector-srv:blueObjList instead.")
  (blueObjList m))

(cl:ensure-generic-function 'blackObjList-val :lambda-list '(m))
(cl:defmethod blackObjList-val ((m <DetectObjectSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_color_detector-srv:blackObjList-val is deprecated.  Use object_color_detector-srv:blackObjList instead.")
  (blackObjList m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectObjectSrv-response>)))
  ...
  "object_color_detector/DetectObjectSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectObjectSrv-response)))
  "Returns string type for a service object of type 'DetectObjectSrv-response"
  "object_color_detector/DetectObjectSrvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectObjectSrv)))
  ...
  "object_color_detector/DetectObjectSrv")