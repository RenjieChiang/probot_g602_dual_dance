...
bool operator==(const ::probot_msgs::PredefinedPoint_<ContainerAllocator1> & lhs, const ::probot_msgs::PredefinedPoint_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    lhs.pose == rhs.pose &&
    lhs.joints == rhs.joints &&
    lhs.digitalOutput == rhs.digitalOutput &&
    lhs.relayOutput == rhs.relayOutput &&
    lhs.pointDelayBeforeExecute == rhs.pointDelayBeforeExecute;
}
