...
bool operator==(const ::probot_msgs::ProbotStatus_<ContainerAllocator1> & lhs, const ::probot_msgs::ProbotStatus_<ContainerAllocator2> & rhs)
{
  return lhs.jointsPosition == rhs.jointsPosition &&
    lhs.probotPose == rhs.probotPose &&
    lhs.inputIOs == rhs.inputIOs &&
    lhs.outputIOs == rhs.outputIOs &&
    lhs.outputRelay == rhs.outputRelay &&
    lhs.inputButton == rhs.inputButton &&
    lhs.inputLimitSensors == rhs.inputLimitSensors &&
    lhs.inputHomeSensors == rhs.inputHomeSensors;
}
