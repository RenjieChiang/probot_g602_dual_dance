...
bool operator==(const ::probot_msgs::RefreshConfigSrvResponse_<ContainerAllocator1> & lhs, const ::probot_msgs::RefreshConfigSrvResponse_<ContainerAllocator2> & rhs)
{
  return lhs.code == rhs.code &&
    lhs.config_feedback == rhs.config_feedback;
}
...
struct MD5Sum< ::probot_msgs::RefreshConfigSrvResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x46cb22b112e1f12cULL;
  static const uint64_t static_value2 = 0x07576f208de9bf83ULL;
};
